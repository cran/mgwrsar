#' BP_pred_MGWRSAR
#' to be documented
#' @usage BP_pred_MGWRSAR(YS,X,W,e,beta_hat,lambda_hat,S,O,coord,type='BPN',k=16,Wk=NULL)
...
BP_pred_MGWRSAR <-
function(YS,X,W,e,beta_hat,lambda_hat,S,O,coord,type='BPN',k=16,Wk=NULL){
###  YS = c(Y_insample)
...
if(is.null(Wk)) Wk=(Beta_extropolation(coord=coord,k=k,O,type='S+OxS+O'))[-S,-O]
