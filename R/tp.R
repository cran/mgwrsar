...
#' @usage tp(K,Residuals,coords,kWtp,Wtp=NULL,prev_TP=NULL)
...
#' @noRd
tp<-function(K,Residuals,coords,kWtp,Wtp=NULL,prev_TP=NULL){
  n=length(Residuals)
  indexG<-(knn(coords,k=max(kWtp+1,K+1)))$nn.idx
